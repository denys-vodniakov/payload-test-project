  ...
  const fetchStats = async () => {
    try {
      ...
      const mockStats: Stats = {
        ...
        categoryStats: [
          { category: 'React', tests: 4, averageScore: 85 },
          { category: 'Next.js', tests: 3, averageScore: 72 },
          { category: 'JavaScript', tests: 3, averageScore: 80 },
          { category: 'TypeScript', tests: 2, averageScore: 75 },
        ],
        recentResults: [
          {
            id: '1',
          ...
          {
            id: '2',
            test: { id: '2', title: 'Next.js 15 Features', category: 'nextjs', difficulty: 'hard' },
            score: 65,
            correctAnswers: 13,
            totalQuestions: 20,
            timeSpent: 1200,
          ...
          {
            id: '3',
            test: { id: '3', title: 'JavaScript ES6+', category: 'javascript', difficulty: 'easy' },
            score: 90,
            correctAnswers: 18,
            totalQuestions: 20,
            timeSpent: 600,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">Статистика ваших тестов и достижений</p>
        </div>
